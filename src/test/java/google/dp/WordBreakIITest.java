...
public class WordBreakIITest {
    ...
    public void test() {
        ...
        assertThat(test.wordBreakIII("catsanddog", s), IsIterableContainingInAnyOrder.containsInAnyOrder("cats and dog", "cat sand dog"));
    }
...
//                ["a","aa","aaa","aaaa","aaaaa","aaaaaa","aaaaaaa","aaaaaaaa","aaaaaaaaa","aaaaaaaaaa"]
        ...
        assertTrue(test.wordBreakIII("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", s).isEmpty());
    }
}