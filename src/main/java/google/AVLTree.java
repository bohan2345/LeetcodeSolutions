...
public class AVLTree implements BinarySearchTree {
     ...
     *
     * @param root
     *         root of the subtree to be rotated left
     * @param right
     *         right child of the root, not left-heavy
     ...
     *
     * @param root
     *         root of the subtree to be rotated right
     * @param left
     *         left child of the root, not right-heavy
     * @return new root of rebalanced subtree
     */
     ...
     * @param right
     *         right child of the root, left-heavy, height(right) == height(root.left) + 2
     * @return new root of rebalanced subtree
     */
     ...
     *         root of subtree to be rotated
     * @param left
     *         left child of the root, right-heavy, height(left) == height(root.right) + 2
     * @return new root of rebalanced subtree
     */
