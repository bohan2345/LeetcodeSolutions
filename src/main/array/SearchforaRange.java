...
/**
 * Given a sorted main.array of integers, find the starting and ending position of a given target value. <br>
 * Your algorithm's runtime complexity must be in the order of O(log n). <br>
 * If the target is not found in the main.array, return [-1, -1]. <br>
 * For example,<br>
