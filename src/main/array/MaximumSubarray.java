...
/**
 * Find the contiguous subarray within an main.array (containing at least one number) which has the largest sum.
 * <br>
 * For example, given the main.array [-2,1,-3,4,-1,2,1,-5,4],<br>
